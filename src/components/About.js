...
const dummyData = [
  ...
  },
  {
    ...
    servings: "2",
    description:
      "A delicious homemade double choclate cake that will satisfy the biggest chocolate cravings!",
    ingredients:
  ...
  },
  {
    ...
    calories: null,
    servings: null,
    description: "sweet dough choc chip gooey",
    ingredients: "flour, chocolate, butter, sugar",
    directions: "mix ingredients in large bowl, knead and bake for 20",
    Notes: "Dont overwork the dough.  Remove from oven when still soft ",
    source: "Ali",
    bio: "mmm cookies ",
    source_image: " ",
    user_id: 55
  },
  {
    ...
    title: "secret recipe lasagnes",
    categories: null,
    prepTime: null,
    cookTime: null,
    calories: null,
    servings: null,
    description: "Granny's secret recip",
    ingredients: "pasta, cheese, bolognese, bechamel, tomato",
    directions: "layer blah blah blah",
    Notes: " ",
    source: "Ali",
    bio: "mmm cheese ",
    source_image: " ",
